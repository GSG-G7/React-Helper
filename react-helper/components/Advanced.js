...
class Advanced extends Component {
  ...
  handelSubmit = () => {
    ...
    if (userScore === 10) {
      this.setState({
        show: true,
        btnTitle: 'Go to the Project',
        screen: 'Project',
        message: 'Congratulations, you have acheived all levels successfully'
      });
    } else {
      this.setState({
        show: true,
    ...
    return (
      <View style={styles.container}>
        <View style={styles.profile}>
          ...
          <Text style={styles.profile__mainQ}>Level : Advanced</Text>
          ...
          <View style={styles.profile__questions}>
            ...
            <View style={show ? styles.activScreen : styles.hiddenScreen}>
              <Text style={{ color: 'black', textAlign: 'center' }}>
                your score is <Text>{userScore}</Text> /10
              </Text>
              <Text style={{ color: 'black', textAlign: 'center' }}>
                {message}
              </Text>
